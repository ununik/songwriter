...
$html->addScript("<script type='text/javascript' src='js/editor.js'></script>");
$html->addScript('<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>');
$html->addScript('<script type="text/javascript" src="/js/moo-clientcide-1.3.js?update_06_12_2015_2"></script>');
$html->addScript('<script type="text/javascript" src="js/ajax.js"></script>');
